<?php
//USERDAO - DATA OBJECT ACCESS - GERE TOUT CE QUI CONCERNES LES USERS - RECUPERE, STOCK ET EFFECTUE DES ACTIONS SUR LA BDD - UTILISE LE MODEL USER POUR INSTANCIER DES OBJETS AVEC LES INFORMATIONS RECUPEREES
